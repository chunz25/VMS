...
<hr>		  
		<div class="row">
				<div class="col-xs-12">				
					...
					<!-- button 1 --------- -->					
						<a class="btn btn-default btn-flat btn-sm btn-info"  onclick="cobayy('RETURN+PROCESS','400501','<?= $_REQUEST["param_menu3"];?>&param_menu4=1');"><i class="fa fa-edit"></i><b>BACK TO LIST RETURN</b></a>
					   <!-- button 2 ---------- -->
