...
$sql_400402_02 = "SELECT * FROM proforma_invoice_all_status_v where ( status_pfi in('34') )  and revision_seq>0 and document_status is null ".$sql_400401_01;
		...
		<TBODY>
			...
			?>
			  <tr valign="top">      
				...
				<td  align="center"><button class="btn btn-warning btn-xs btn-flat" data-toggle="modal" data-target="#add01" onclick="cobayy('PROFORMA+INVOICE','400403_03_01','<?= $arr['proforma_invoice_no'];?>&param_menu4=<?= $arr['status_pfi'];?>');" ><?= $view_action;?> </button></td>					
			  </tr>
			<?php } ?>
		</TBODY>
		</TABLE>
