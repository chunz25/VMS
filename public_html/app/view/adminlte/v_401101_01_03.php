...
<hr>
            ...
            <div class="col-xs-12">
				<div class="box-tools pull-right">
					<a class="btn btn-default btn-flat btn-sm btn-info"  onclick="cobayy('DISPUTE+QUANTITY','401101','<?php echo $_REQUEST["param_menu3"];?>');"><i class="fa fa-edit"></i> <b>BACK TO LIST GR</b></a>
