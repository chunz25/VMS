              ...
              <h2 class="page-header">
               <?= $_REQUEST["param_menu1"];?> #<?= $_REQUEST["param_menu3"];?>
					<div class="box-tools pull-right">					
						...
						<a class="btn btn-default btn-flat btn-sm btn-danger" onclick="bukaModalHelmizz301('#tempatmodal','index.php?main=040&main_act=010&main_id=400401_01_02&po_no=<?= urlencode($data_header['purchase_order_no']); ?>','','#tampil2');">
