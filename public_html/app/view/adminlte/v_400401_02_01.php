          ...
          <div class="row">
            <div class="col-xs-12">
              <h2 class="page-header">
               <?= $_REQUEST["param_menu1"];?> [REQ TO CANCEL] #<?= $_REQUEST["param_menu3"];?>
              </h2>			 
            </div><!-- /.col -->
          </div>
          <!-- info row -->
		...
		<div class="row">
				<div class="col-xs-12">	
					<div class="box-tools pull-left">
						<!-- button 1 -------- -->
							<a class="btn btn-default btn-flat btn-sm btn-info"  onclick="cobayy('PURCHASE+ORDER','400401','&param_menu4=2');"><i class="fa fa-edit"></i> <b>BACK TO LIST PO</b></a>
						<!-- button 2 --------- -->
