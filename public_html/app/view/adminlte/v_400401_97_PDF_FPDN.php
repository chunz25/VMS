...
// FAKTUR PAJAK DEBIT NOTE ===========================================
	...
	*/		
	...
	// $namafilepdf=md5(sha1($_REQUEST["goods_receive_no"])).".pdf";
	 $namafilepdf=$_REQUEST["doc_no"].".pdf";
?>
<div class="modal fade" id="tampil10" role="dialog" style="overflow-y: auto;" >
	<div class="modal-dialog modal-lg">
		...
		PRINT FAKTUR PAJAK # <?php echo $_REQUEST["doc_no"];?> <!-- || <?php echo $namafilepdf;?> || <?php echo $_REQUEST["po_no"];?> -->
		</h4>
        ...
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
			...
			<div class="modal-body" align="left">
				...
				<embed src="_docs/DNFP/<?php echo $namafilepdf;?>" frameborder="0" width="100%" height="450px">
