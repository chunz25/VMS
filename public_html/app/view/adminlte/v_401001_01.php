		...
		<TBODY>
			...
			?>
			  <tr valign="top">      
				...
				<td  align="center"><button class="btn btn-warning btn-xs btn-flat" data-toggle="modal" data-target="#add01" onclick="cobayy('PROFORMA+INVOICE','401001_01_01','<?= $arr['proforma_invoice_no'];?>&param_menu4=<?= $arr['status_pfi'];?>');" ><?= $view_action;?> </button></td>			
			  </tr>
			<?php } ?>
		</TBODY>
		</TABLE>
