...
switch ($_SESSION['tb_id_user_type']) {
    case 1:
        ...
        break;
    case 2:
        $sql_400402_01 = " AND  department in (".$_SESSION['department'].")";
        break;
    case 3:
...
//$sql_400402_01 = " AND supplier_code='".$_SESSION['supplier_code']."'";
$sql_400402_02 = "SELECT a.* FROM proforma_invoice_all_status_v a  where ( a.status_pfi in('32','33') ) and a.document_status is null".$sql_400402_01;
...
<!-- Content Header (Page header) -->
		...
		<TBODY>
			...
			while ($arr = $rs->FetchRow()) { 
				...
				$view_status=($arr['status_pfi']==32)? "Dispute Price By Supplier" : "Dispute Price By SUPERECO" ;
			?>
			  <tr valign="top">      
				...
				<td  align="center"><button class="btn btn-warning btn-xs btn-flat" data-toggle="modal" data-target="#add01" onclick="cobayy('PROFORMA+INVOICE','401001_01_01','<?php echo $arr['proforma_invoice_no'];?>&param_menu4=<?php echo $arr['status_pfi'];?>');" ><?php echo $view_action;?> </button></td>			
			  </tr>
			<?php } ?>
		</TBODY>
		</TABLE>
