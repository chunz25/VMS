...
<div class="modal fade" id="tampil4" role="dialog" style="overflow-y: auto;" >
	<div class="modal-dialog modal-lg">
		...
		PRINT GOODS RECEIVE NOTE (GRN) # <?php echo $_REQUEST["goods_receive_no"];?> <!-- || <?php echo $namafilepdf;?> || <?php echo $_REQUEST["po_no"];?> -->
		</h4>
        ...
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
			...
			<div class="modal-body" align="left">
				...
				<embed src="_docs/GR/<?php echo $namafilepdf;?>" frameborder="0" width="100%" height="450px">
