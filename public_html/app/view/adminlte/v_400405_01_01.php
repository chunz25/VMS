...
?>
        ...
        <section class="invoice">
          ...
          <div class="row">
            <div class="col-xs-12">
				<h2 class="page-header"> <?= $_REQUEST["param_menu1"];?> #<?= $_REQUEST["invrno"];?> </h2>
           </div><!-- /.col -->
          </div>
          <!-- info row -->
            ...
            <div class="col-xs-6" >&nbsp;
			 <form role="form" id="my_form" action="index.php" method="post" enctype="multipart/form-data">
					...
					<div class="form-group">
                      ...
                      <label for="exampleInputFile">File Faktur Pajak 22</label>
					...
					<button type="submit" class="btn btn-default btn-flat btn-sm btn-info" align="right"><i class="fa fa-edit"></i> <b>SUBMIT TO INVOICE RECEIPT</b></button>
          ...
          <div class="row no-print">
            <div class="col-xs-12">
				<div class="box-tools pull-left">
				  <!-- button 1 -------- -->
					<a class="btn btn-default btn-flat btn-sm btn-info"  onclick="cobayy('INVOICE+RECEIPT','400405','&param_menu4=1');"><i class="fa fa-edit"></i> <b>BACK TO LIST INVOICE RECEIPT</b></a>
				  ...
				  <!-- button 4 -------- 
					<a class="btn btn-default btn-flat btn-sm btn-default"  onclick="bukaModalHelmizz301('#tempatmodal','index.php?main=040&main_act=010&main_id=400401_93&po_no=<?= urlencode($data_header['purchase_order_no']); ?>','','#tampil6');"><i class="fa fa-print"></i> <b>PFI</b></a> -->
				 <!-- button 5 -------- -->
					<a class="btn btn-default btn-flat btn-sm btn-default"  onclick="bukaModalHelmizz301('#tempatmodal','index.php?main=040&main_act=010&main_id=400401_94&po_no=<?= urlencode($data_header['purchase_order_no']); ?>','','#tampil7');"><i class="fa fa-print"></i> <b>INVOICE</b></a>
				 <!-- button 6 -------- -->
					<a class="btn btn-default btn-flat btn-sm btn-default"  onclick="bukaModalHelmizz301('#tempatmodal','index.php?main=040&main_act=010&main_id=400401_95&po_no=<?= urlencode($data_header['purchase_order_no']); ?>','','#tampil8');"><i class="fa fa-print"></i> <b>INVOICE RECEIPT</b></a>
				<!-- button 7 -------- -->
				<?php 
				if($data_header[vat_amount]>0){
					?>
					<a class="btn btn-default btn-flat btn-sm btn-default"  onclick="bukaModalHelmizz301('#tempatmodal','index.php?main=040&main_act=010&main_id=400401_96&po_no=<?= urlencode($data_header['purchase_order_no']); ?>','','#tampil9');"><i class="fa fa-print"></i> <b>FAKTUR PAJAK</b></a>
				<?php }?>
				</div>
