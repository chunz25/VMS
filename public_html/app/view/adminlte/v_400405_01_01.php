...
?>
        ...
        <section class="invoice">
          ...
          <div class="row">
            <div class="col-xs-12">
				<h2 class="page-header"> <?php echo $_REQUEST["param_menu1"];?> #<?php echo $_REQUEST["invrno"];?> </h2>
           </div><!-- /.col -->
          </div>
          <!-- info row -->
          ...
          <div class="row no-print">
            <div class="col-xs-12">
				<div class="box-tools pull-left">
				 ...
				 <!-- button 5 -------- -->
					<a class="btn btn-default btn-flat btn-sm btn-default"  onclick="bukaModalHelmizz301('#tempatmodal','index.php?main=040&main_act=010&main_id=400401_94&po_no=<?php echo urlencode($data_header['purchase_order_no']); ?>','','#tampil7');"><i class="fa fa-print"></i> <b>INVOICE</b></a>
				 <!-- button 6 -------- -->
					<a class="btn btn-default btn-flat btn-sm btn-default"  onclick="bukaModalHelmizz301('#tempatmodal','index.php?main=040&main_act=010&main_id=400401_95&po_no=<?php echo urlencode($data_header['purchase_order_no']); ?>','','#tampil8');"><i class="fa fa-print"></i> <b>INVOICE RECEIPT</b></a>
				<!-- button 7 -------- -->
				<?php 
				if($data_header[vat_amount]>0){
					?>
					<a class="btn btn-default btn-flat btn-sm btn-default"  onclick="bukaModalHelmizz301('#tempatmodal','index.php?main=040&main_act=010&main_id=400401_96&po_no=<?php echo urlencode($data_header['purchase_order_no']); ?>','','#tampil9');"><i class="fa fa-print"></i> <b>FAKTUR PAJAK</b></a>
				<?php }?>
				</div>
