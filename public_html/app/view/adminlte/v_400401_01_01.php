	...
	<div class="row">
		...
		<div class="col-xs-6">
			<p class="text-muted well well-sm no-shadow" style="margin-top: 10px;">
				...
				&nbsp; &nbsp;Lalu Informasikan Buyer GORO untuk setting price/tax rate dengan benar
			</p>
		</div><!-- /.col -->
		<div class="col-xs-6">
	...
	<div class="row">
		<div class="col-xs-12">
			...
			<div class="box-tools pull-left">
				<!-- button 1 --------- -->
				<a class="btn btn-default btn-flat btn-sm btn-info" onclick="cobayy('PURCHASE+ORDER','400401','<?= $_REQUEST["param_menu3"]; ?>&param_menu4=1');"><i class="fa fa-edit"></i><b>BACK TO LIST PO</b></a>
				<!-- button 2 --------- -->
