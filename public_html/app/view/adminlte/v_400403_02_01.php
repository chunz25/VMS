          ...
          <div class="row no-print">
            <div class="col-xs-12">
				...
				<div class="box-tools pull-right">
				 ...
				 <!-- button 5 -------- -->
					<a class="btn btn-default btn-flat btn-sm btn-danger" onclick="dispute_process('Apakah Anda Yakin akan memproses dispute price.... ?','DISPUTE+PRICE','400403_02_03','<?= $_REQUEST["param_menu3"];?>')"><i class="fa fa-edit"></i><b>DISPUTE PRICE</b></a>	
				 <?php }?>
				</div>
            </div>
          </div>
