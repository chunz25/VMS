		...
		<div class="row no-print">
            ...
            <div class="col-xs-12">
				<div class="box-tools pull-right">
					<a class="btn btn-default btn-flat btn-sm btn-info"  onclick="cobayy('DISPUTE+PRICE','400403','<?= $_REQUEST["param_menu3"];?>&param_menu4=2');"><i class="fa fa-edit"></i> <b>BACK TO LIST</b></a>	
