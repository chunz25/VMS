		...
		<TBODY>
			...
			?>
			  <tr valign="top">      
				...
				<td  align="center"><button class="btn btn-warning btn-xs btn-flat" data-toggle="modal" data-target="#add01" onclick="cobayy('GOODS+RECEIVE','400402_02_01','<?= $arr['goods_receive_no'];?>&param_menu4=<?= $arr['status_grn'];?>');" ><?= $view_action;?> </button></td>				
			  </tr>
			<?php } ?>
		</TBODY>
		</TABLE>
