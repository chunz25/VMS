...
while ($arr = $rs->FetchRow()) { ?>
      <tr valign="top">       
        ...
        <td align="right"><?php echo $arr['po_no_original'];?></td>  
<td  align="center"><button class="btn btn-warning btn-xs btn-flat" data-toggle="modal" data-target="#add01" onclick="cobayy('RETURN','400502_00_01','<?php echo $arr['goods_return_no'];?>&param_menu4=<?php echo $arr['backorder_flag']?>');" >View</button></td>		
      </tr>
<?php } ?>
</TBODY>
</TABLE>
