...
while ($arr = $rs->FetchRow()) { ?>
      <tr valign="top">
        ...
        <td  align="center"><button class="btn btn-warning btn-xs btn-flat" data-toggle="modal" data-target="#add01" onclick="cobayy('PURCHASE+ORDER','401102_00_01','<?php echo $arr['purchase_order_no'];?>');" >View Detail</button></td>
      </tr>
<?php } ?>
</TBODY>
</TABLE>
