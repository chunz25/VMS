        ...
        <section class="invoice">
          ...
          <div class="row">
            <div class="col-xs-12">
              <h2 class="page-header">
               <?= $_REQUEST["param_menu1"];?> [CANCELLED] #<?= $_REQUEST["param_menu3"];?>
            ...
            <div class="col-sm-4 invoice-col">
			  ...
			  <table width="95%">
				  ...
				  <tr>
					  ...
					  <td valign="top"> : </td>
					  <td valign="top" align="right"><?= $data_note_req[req_date];?></td>
				  <tr>
			  </table>             
            </div><!-- /.col -->
          </div><!-- /.row -->
              ...
              <table class="table table-bordered table-striped">
				...
				while ($arr = $rs->FetchRow()) { ?>
					  <tr valign="top">						
						...
						<td align="right"><?= number_format($arr['vat_amount']+$arr['amount']);?></td>							
					  </tr>
				<?php } ?>
				</TBODY>
				</TABLE>
          ...
          <div class="row">
            ...
            <div class="col-xs-6">             
			  ...
			  <b> Note :</b> </br>
				- <?= $data_note_req[reason];?></br>
                - <?= $data_note_req[user_req_note];?></br>          
              </p>
            </div><!-- /.col -->
            <div class="col-xs-6">             
		...
		<div class="row">
			<div class="col-xs-12">	
				<div class="box-tools pull-left">	
					<!-- button 1 -------- -->				
					<a class="btn btn-default btn-flat btn-sm btn-info"  onclick="cobayy('PURCHASE+ORDER','400401','<?= urlencode($data_header['purchase_order_no']); ?>&param_menu4=3');"><i class="fa fa-edit"></i> <b>BACK TO LIST PO</b></a>
					<!-- button 2 -------- -->
