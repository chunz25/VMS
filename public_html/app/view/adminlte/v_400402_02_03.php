...
<hr>
            ...
            <div class="col-xs-12">
				<div class="box-tools pull-right">
					<a class="btn btn-default btn-flat btn-sm btn-info"  onclick="cobayy('GOODS+RECEIVE','400402','<?= $_REQUEST["param_menu3"];?>&param_menu4=2');"><i class="fa fa-edit"></i> <b>BACK TO LIST GR</b></a>
...
$("#my_form").submit(function(event){
    ...
    $.ajax({
		...
		alert(response);
		if(response=='success'){
			alert('Dispute quantity Sudah diproses, Menunggu confirm dari Goods receiving SUPERECO ...');
			//$(".close").click()
