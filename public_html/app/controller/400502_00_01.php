...
// data PO line -------------
$sql002 = "SELECT * FROM goods_return_item WHERE goods_return_no='" . $_REQUEST["param_menu3"] . "' and version=2 and backorder_flag='" . $_REQUEST["param_menu4"] . "' order by CAST(line_item AS UNSIGNED)";
		...
		<div class="col-xs-12">
			<div class="box-tools pull-left">
				...
				<a class="btn btn-default btn-flat btn-sm btn-info"
					onclick="cobayy('RETURN+FINISHED','400502','<?= $_REQUEST["param_menu3"]; ?>&param_menu4=1');"><i
				...
				<!-- button 4 --------- -->
				<a class="btn btn-default btn-flat btn-sm btn-default"
					onclick="bukaModalHelmizz301('#tempatmodal','index.php?main=040&main_act=010&main_id=400401_99&doc_no=<?= $data_header["document_no"]; ?>','','#tampil12');"><i
						class="fa fa-print"></i> <b>PRINT CREDIT NOTE</b></a>
			</div>
		</div>
	</div>
