...
$sql_400401_02 = "select * from stock_opname where MP_STOCK>0 and qty_2<=0 and qty_1>0 ".$sql_400401_01;
//die($sql_400401_02);
...
?>
      ...
      <tr valign="top">
		...
		<button onclick="updatedata2('q<?php echo $x;?>','a<?php echo $x;?>','k<?php echo $x;?>')" type="button"  name="ccc" class="btn btn-primary" >Submit</button></td>
      </tr>
...
<script>
function updatedata2(param1,param2,param3){
	//alert(param1);
	//alert(param2);
	//alert(param3);
	var urlaction="https://vms.supereco.id/index.php?main=040&main_act=010&main_id=900001_02_01&"
	var v1 = $("#"+param1).val();
	// alert(v1);
	var v2 = $("#"+param2).val();
	// alert(v2);
