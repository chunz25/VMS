...
?>
        ...
        <section class="invoice">
          ...
          <div class="row">
            <div class="col-xs-12">
				<h2 class="page-header"><?php echo $_REQUEST["param_menu1"];?> #<?php echo $_REQUEST["param_menu3"];?> [Dispute Price Finished]</h2>			  
            </div><!-- /.col -->
          </div>
          <!-- info row -->
          ...
          <div class="row">
			  ...
			  <?php // echo $sql002;?>
				...
				<THEAD>
					  <tr valign="top">					
						...
						<th align="right"><b>UNIT PRICE FIRST</b></th>
			...
			?>
					  <tr valign="top">					
						...
						<td align="right"><?php echo number_format($arr['unit_price_ori']);?></td>
          ...
          <div class="row no-print">
            <div class="col-xs-12">
				...
				<?php
					...
					<a class="btn btn-default btn-flat btn-sm btn-info"  onclick="cobayy('PROFORMA+INVOICE','400403','&param_menu4=3');"><i class="fa fa-edit"></i> <b>BACK TO LIST PFI</b></a>
				<?php	
				}
				?>	
				 <!-- button 2 ---------- -->
