...
<button class="btn btn-success btn-xs btn-flat" onclick="bukaModalHelmizz301('#tempatmodal03','index.php?main=040&main_act=010&main_id=400102_03_01','','#tampil03');"><i class="fa fa-edit"></i> Add User Finance</button>					 
