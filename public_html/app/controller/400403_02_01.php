             ...
             <b>Proforma Invoice No #<u><?php echo $_REQUEST["param_menu3"];?></u></b><br/>
			  ...
			  <table width="90%">
				  ...
				  <tr>
					  ...
					  <td align="right">
					  +<?php echo $hp_buyer;?> 
					  <a href="<?php echo $wa_address;?>" target="whatsappWeb"><button class="btn btn-info btn-xs btn-flat"  data-toggle="tooltip" title="Chat via WhatsApp Web <?php echo $hp_buyer;?> " ><i class="fa fa-whatsapp"></i></button></a></td>
				  <tr>
	...
	<hr>
          ...
          <div class="row no-print">
            <div class="col-xs-12">
				...
				<!-- button 1 -------- -->
					<a class="btn btn-default btn-flat btn-sm btn-info"  onclick="cobayy('PROFORMA+INVOICE','400403','&param_menu4=2');"><i class="fa fa-edit"></i> <b>BACK TO LIST SETTLEMENT PRICE</b></a>
				 <!-- button 2 ---------- -->
				...
				<div class="box-tools pull-right">
				 <?php if($_REQUEST["param_menu4"]=='33' || $_REQUEST["param_menu4"]=='34') { ?>
					<!-- button 4 -------- 
					...
					)"><i class="fa fa-edit"></i><b>CONFIRM & SEND INVOICE</b></a>
					-->
					
					
					<a class="btn btn-default btn-flat btn-sm  btn-warning" onclick="bukaModalHelmizz301('#tempatmodalTF2','index.php?main=040&main_act=010&main_id=400404_01_04&po_no=<?php echo urlencode($data_header['purchase_order_no']); ?>&gr_no=<?php echo urlencode($data_header['goods_receive_no']); ?>&ttl_amt=<?php echo urlencode($data_header['total_amount']); ?>&vat_amt=<?php echo urlencode($data_header['vat_amount']); ?>&grd_amt=<?php echo urlencode($data_header['grand_total']); ?>&npwp_no=<?php echo urlencode($data_header_supplier['npwp']); ?>&pfi_no=<?php echo urlencode($data_header['proforma_invoice_no']); ?>&status_pfi=<?php echo urlencode($data_header['status_pfi']); ?>','','#tampil2');"><i class="fa fa-edit"></i> <b>SEND INVOICE </b></a>	
					
					
				<?php 
				 }
				if($_REQUEST["param_menu4"]=='33'){ ?>
				 <!-- button 5 -------- -->
