...
<THEAD>
      <tr valign="top">
        ...
        <!-- <td align="center"><b>PAYMENT DESCRIPTION</b></td> -->
...
while ($arr = $rs->FetchRow()) { ?>
      <tr valign="top">
        ...
        <td align="right"><?php echo number_format($arr['potongan'],0);?></td>
        <td align="right"><?php echo number_format($arr['net_payment'],0);?></td>
        <td  align="center"><button class="btn btn-warning btn-xs btn-flat" data-toggle="modal" data-target="#add01" onclick="cobayy('PAYMENT+DETAIL','400701_00_01','<?php echo $arr['payment_no'];?>&cc=<?php echo $arr['company_code'];?>');" >VIEW DETAIL</button></td>
