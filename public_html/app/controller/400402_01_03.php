			...
			<div class="col-xs-12">
				<div class="box-tools pull-right">
					<a class="btn btn-default btn-flat btn-sm btn-info"
						onclick="cobayy('GOODS+RECEIVE','400402_01_01','<?= $_REQUEST["param_menu3"]; ?>');"><i
							class="fa fa-edit"></i> <b>BACK TO LIST SETTLEMENT QTY</b></a>
		...
		if (confirm('Apakah Data Sudah diisi dengan benar ?')) {
			...
			$.ajax({
				...
				if (response == 'success') {
					...
					cobayy('SETTLEMENT+QUANTITY', '400402', '1');
				} else {
					alert('Gagal dispute quantity proses : ' + response);
					return false;
				}
			});
		} else {
