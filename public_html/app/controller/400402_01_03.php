		...
		<div class="row no-print">
			...
			<div class="col-xs-12">
				<div class="box-tools pull-right">
					<a class="btn btn-default btn-flat btn-sm btn-info" onclick="cobayy('GOODS+RECEIVE','400402_01_01','<?php echo $_REQUEST["param_menu3"]; ?>');"><i class="fa fa-edit"></i> <b>BACK TO LIST SETTLEMENT QTY</b></a>
	...
	$("#my_form").submit(function(event) {
		if (confirm('Apakah Data Sudah diisi dengan benar ?')) {
			...
			$.ajax({
				...
				// alert(response);
				if (response == 'success') {
					alert('Dispute quantity Sudah diproses, Menunggu confirm dari ELECTRONIC CITY ...');
					//$(".close").click()
					cobayy('SETTLEMENT+QUANTITY', '400402', '');
				} else {
