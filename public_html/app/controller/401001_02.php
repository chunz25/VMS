...
switch ($_SESSION['tb_id_user_type']) {
	case 1: // admin
		...
		break;
	case 2: // buyer
		$sql_400402_01 = "  AND '" . $dept . "' like concat('%', a.department ,'%') ";
		break;
	case 3: // finance
		$sql_400402_01 = " ";
		break;
...
$sql_400402_02 = "SELECT a.*,b.name FROM proforma_invoice_all_status_v a left join supplier b on a.supplier_code=b.supplier_code  where ( a.status_pfi in('34','35') )  and revision_seq>0 and a.document_status is null" . $sql_400402_01;
			...
			while ($arr = $rs->FetchRow()) {
				...
				<tr valign="top">
					...
					<td align="center"><button class="btn btn-warning btn-xs btn-flat" data-toggle="modal" data-target="#add01"
							onclick="cobayy('PROFORMA+INVOICE','401001_02_01','<?= $arr['proforma_invoice_no']; ?>&param_menu4=<?= $arr['status_pfi']; ?>');"><?= $view_action; ?>
						</button></td>
				</tr>
			<?php } ?>
	</TBODY>
