	...
	<div class="box box-solid" id="isicontentovl" style="padding:0px;"> <!--style="overflow-y:auto;padding:0px;"-->
		<div class="box-header with-border">
			...
			<div class="box-tools pull-right">
				<button class="btn btn-primary btn-xs btn-flat" data-toggle="modal" data-target="#add01"
					onclick="klikallcekbox();">SELECT ALL</button>
				...
				<button class="btn btn-primary btn-xs btn-flat" data-toggle="modal"
					data-target="#add01">PROCESS</button>
