			...
			<div class="col-sm-4 invoice-col">
				...
				<table width="75%">
					...
					<tr>
						...
						<td> : </td>
						<td align="right"><?= $data_header['purchase_order_date']; ?></td>
					<tr>
			...
			<div class="col-xs-12">
				<div class="box-tools pull-right">
					<a class="btn btn-default btn-flat btn-sm btn-info"
						onclick="cobayy('DISPUTE+QUANTITY','401101','<?= $_REQUEST["param_menu3"]; ?>');"><i
							class="fa fa-edit"></i> <b>BACK TO SETTLEMENT QTY</b></a>
