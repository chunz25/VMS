...
$tab_title = array("USER ADMIN", "USER PRODUCT", "USER SNDP", "USER FINANCE", "USER LOGISTIC", "USER SUPPLIER", "USER GROUP SUPP", "GROUP USER");
...
// tab content -----------------------
$tab_content_file = array("400102_01", "400102_08", "400102_02", "400102_03", "400102_04", "400102_05", "400102_06", "400102_07");
			...
			<div class="tab-content">
				...
				foreach ($tab_ahref as $tab_ahref_index => $tab_ahref_content) {
					...
					<div class="<?= $tab_class2 ?>" id="<?= $tab_ahref_content ?>">
						<?php include $_MAIN__CONFIGS_000[4] . $tab_content_file[$tab_ahref_index] . ".php"; ?>
					</div>
				<?php
				}
				?>
