...
<div class="modal fade" id="tampil03" role="dialog">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<h4 class="modal-title" id="exampleModalCenterTitle">CREATE USER
					FINANCE<?= $_REQUEST["po_no"]; ?></h4>
						...
						<table class="tabelpopup">
							...
							<tbody>
								<tr>
									...
									<td class="tdpopup"><b>Finance</b></td>
								</tr>
								<tr>
									<td class="tdpopup" align="right" width="40%">Group Akses</td>
									<td class="tdpopup"><b>Finance Group User</b></td>
								</tr>
								<tr>
