			...
			<div class="col-xs-12">
				<div class="box-tools pull-right">
					<a class="btn btn-default btn-flat btn-sm btn-info"
						onclick="cobayy('DISPUTE+PRICE','401001','<?= $_REQUEST["param_menu3"]; ?>');"><i
...
<script>
	$("#my_form").submit(function (event) {
		...
		$.ajax({
			...
			alert(response);
			if (response == 'success') {
				alert('Dispute price Sudah diproses, Menunggu confirm dari Supplier ...');
				cobayy('DISPUTE+PRICE', '401001', '');
			} else {
