	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<h4 id="exampleModalCenterTitle">REJECT RECEIPT SUPPLIER # <?= $_REQUEST["gr_no"]; ?></h4>
			...
			<div class="modal-body" align="left">
				<form role="form" id="my_form_Reject" action="index.php" method="post" enctype="multipart/form-data">
					...
					<div class="box-footer" align="center">
						...
						<input type="hidden" name="inv_supp_no" value="<?= $_REQUEST["inv_supp_no"]; ?>">
...
<script>
	...
	function prosesSubmitX(param1, param2, param3) {
		$.ajax({
			...
			if (response == 'success') {
				alert('Reject Proses Invoice receipt done , menunggu supplier memenuhi persyaratannya kembali ...');
