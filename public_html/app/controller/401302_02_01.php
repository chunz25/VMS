		...
		<div class="row">
			<div class="col-xs-12">	
				<div class="box-tools pull-left">	
					<!-- button 1 -------- -->				
					<a class="btn btn-default btn-flat btn-sm btn-info"  onclick="cobayy('HISTORY+PO','401302','<?php echo urlencode($data_header['purchase_order_no']); ?>&param_menu4=3');"><i class="fa fa-edit"></i> <b>BACK TO LIST PO</b></a>
					<!-- button 2 -------- -->
