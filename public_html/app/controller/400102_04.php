...
<button class="btn btn-success btn-xs btn-flat" onclick="bukaModalHelmizz301('#tempatmodal04','index.php?main=040&main_act=010&main_id=400102_04_01','','#tampil04');"><i class="fa fa-edit"></i> Add User Logistik</button>					 
