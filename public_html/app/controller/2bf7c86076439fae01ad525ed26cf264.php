<?php
// PROFORMA INVOICE  ======================================================================== //
if($pwdnya='730e85e6ce5a47b805e96bf133a8759b'){
	...
	// data INVOICE Header -------------
	$sql001='"select * from proforma_invoice where proforma_invoice_no='."'".$docnonya."'".'"';
	...
	// data item  -----------------
	$sql004='"select * from proforma_invoice_item where proforma_invoice_no='."'".$data_header["proforma_invoice_no"]."'".'"';
...
<table width="100%" border="1" cellpadding="2" cellspacing="0">
	<tr >
		...
		<td style="vertical-align: bottom; text-align: right;">
			<h3> NO : <?php echo $data_header[proforma_invoice_no];?> </h3>
		</td>
	</tr>
</table>
