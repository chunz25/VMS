			...
			while ($arr = $rs->FetchRow()) { ?>
				<tr valign="top">
					...
					<td align="center"><button class="btn btn-warning btn-xs btn-flat" data-toggle="modal" data-target="#add01"
							onclick="bukaModalHelmizz301('#tempatmodal','index.php?main=040&main_act=010&main_id=400205_01_01&po_no=<?= urlencode($arr['purchase_order_no']); ?>','','#tampil2');">Revisi</button>
					</td>
				</tr>
			<?php } ?>
	</TBODY>
