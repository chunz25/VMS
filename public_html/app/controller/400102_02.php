...
<div class="box-body table-responsive" style="padding:2px;">
  <button class="btn btn-success btn-xs btn-flat"
    onclick="bukaModalHelmizz301('#tempatmodal02','index.php?main=040&main_act=010&main_id=400102_02_01','','#tampil02');"><i
      class="fa fa-edit"></i> Add User SNDP</button>
          ...
          <tr valign="top">
            ...
            <td align="center">
              <a href="<?= $wa_address; ?>" target="whatsappWeb"><button class="btn btn-info btn-xs btn-flat"
                  data-toggle="tooltip" title="Chat via WhatsApp Web <?= $hp; ?> "><i
                    class="fa fa-whatsapp"></i></button></a>
              <button class="btn btn-info btn-xs btn-flat" onclick="mailto:('<?= $email; ?>');" data-toggle="tooltip"
                title="Send Email <?= $hp; ?> "><i class="fa fa-envelope"></i></button>
              <button class="btn btn-warning btn-xs btn-flat" onclick="window.open('<?= $wa_address; ?>');"
                data-toggle="tooltip" title="Reset Password <?= $hp; ?> "><i class="fa fa-wrench"></i></button>
              <button class="btn btn-info btn-xs btn-flat" onclick="window.open('<?= $wa_address; ?>');"
                data-toggle="tooltip" title="See Detail <?= $hp; ?> "><i class="fa fa-search"></i></button>
            </td>
          </tr>
        <?php } ?>
    </TBODY>
