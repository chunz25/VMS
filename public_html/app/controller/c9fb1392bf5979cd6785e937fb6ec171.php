...
$sql_060_00 = "select 
				...
				substr(a.tax_no,4) as NOMOR_FAKTUR,
				DATE_FORMAT(a.tax_date,'%d/%m/%Y') as TANGGAL_FAKTUR,
				a.document_no as NOMOR_DOKUMEN_RETUR,
				DATE_FORMAT(a.document_date,'%d/%m/%Y') as TANGGAL_RETUR,
				DATE_FORMAT(a.tax_date,'%m') as MASA_PAJAK_RETUR,
				DATE_FORMAT(a.tax_date,'%Y') as TAHUN_PAJAK_RETUR,
				a.total_amount as NILAI_RETUR_DPP,
				a.vat_amount as NILAI_RETUR_PPN,
				0 as NILAI_RETUR_PPNBM
				FROM goods_return_1_v a 
				join supplier b on a.supplier_code=b.supplier_code
