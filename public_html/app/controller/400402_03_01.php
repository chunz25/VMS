          ...
          <div class="row">
            <div class="col-xs-12">
				<h2 class="page-header">
					<?php echo $_REQUEST["param_menu1"];?> #<?php echo $_REQUEST["param_menu3"];?> [Dispute Quantity Finished]
				</h2>			  
            </div><!-- /.col -->
          </div>
          <!-- info row -->
            ...
            <div class="col-xs-12 table-responsive">             
			  <?php // echo $sql002;?>
				<TABLE  class="table table-striped  table-bordered">
					...
					$qty_rev1 = ($data_header['revision_seq']>0) ? "<h4><span class='label label-success'>".number_format($arr['qty_rev1'])."</span></h4>" : number_format($arr['qty_ori']);
					$qty_rev2 = ($data_header['revision_seq']>1) ? "<h4><span class='label label-success'>".number_format($arr['qty_rev2'])."</span></h4>" : number_format($arr['qty_finish']);
					$qty_rev3 = ($data_header['revision_seq']>2) ? "<h4><span class='label label-success'>".number_format($arr['qty_rev3'])."</span></h4>" : number_format($arr['qty_finish']);
					$qty_rev4 = ($data_header['revision_seq']>3) ? "<h4><span class='label label-success'>".number_format($arr['qty_rev4'])."</span></h4>" : number_format($arr['qty_finish']);
					$qty_rev5 = ($data_header['revision_seq']>4) ? "<h4><span class='label label-success'>".number_format($arr['qty_rev5'])."</span></h4>" : number_format($arr['qty_finish']);
					$qty_rev6 = ($data_header['revision_seq']>5) ? "<h4><span class='label label-success'>".number_format($arr['qty_rev6'])."</span></h4>" : number_format($arr['qty_finish']);
          ...
          <div class="row no-print">
            <div class="col-xs-12">	
				<div class="box-tools pull-left">
				  <!-- button 1 --------- -->
							<a class="btn btn-default btn-flat btn-sm btn-info"  onclick="cobayy('GOODS+RECEIVE','400402','&param_menu4=3');"><i class="fa fa-edit"></i> <b>BACK TO LIST GR</b></a>
							<!-- button 2 ---------- -->
