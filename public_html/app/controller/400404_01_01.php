		...
		<div class="col-xs-6">&nbsp;
			<form role="form" id="my_form" action="index.php" method="post" enctype="multipart/form-data">
				<div class="alert alert-info alert-dismissable">
					...
					<button type="submit" class="btn btn-default btn-flat btn-sm btn-warning" align="right"><i
	...
	<div class="row no-print">
		<div class="col-xs-12">
			<div class="box-tools pull-left">
				...
				<!-- button 2 ---------- -->
				<a class="btn btn-default btn-flat btn-sm btn-default"
					onclick="bukaModalHelmizz301('#tempatmodal','index.php?main=040&main_act=010&main_id=400401_90_PDF_PO&po_no=<?= urlencode($data_header['purchase_order_no']); ?>','','#tampil3');"><i
						class="fa fa-print"></i> <b>PO</b></a>
				<!-- button 3 ---------- -->
				<a class="btn btn-default btn-flat btn-sm btn-default"
					onclick="bukaModalHelmizz301('#tempatmodal','index.php?main=040&main_act=010&main_id=400401_91_PDF_GRN&goods_receive_no=<?= urlencode($data_header['goods_receive_no']); ?>&po_no=<?= urlencode($data_header['purchase_order_no']); ?>','','#tampil4');"><i
						class="fa fa-print"></i> <b>GRN</b></a>
				<!-- button 4 -------- -->
				<a class="btn btn-default btn-flat btn-sm btn-default"
					onclick="bukaModalHelmizz301('#tempatmodal','index.php?main=040&main_act=010&main_id=400401_93_PDF_PFI&po_no=<?= urlencode($data_header['purchase_order_no']); ?>','','#tampil6');"><i
						class="fa fa-print"></i> <b>PFI</b></a>
				<!-- button 5 -------- -->
				<a class="btn btn-default btn-flat btn-sm btn-default"
					onclick="bukaModalHelmizz301('#tempatmodal','index.php?main=040&main_act=010&main_id=400401_94_PDF_INV&po_no=<?= urlencode($data_header['purchase_order_no']); ?>','','#tampil7');"><i
			...
			<div class="box-tools pull-right">
				...
				if ($data_header['vat_amount'] > 0) {
					...
					<a class="btn btn-default btn-flat btn-sm btn-danger"
						onclick="bukaModalHelmizz301('#tempatmodalTF','index.php?main=040&main_act=010&main_id=400404_01_04&po_no=<?= urlencode($data_header['purchase_order_no']); ?>&gr_no=<?= urlencode($data_header['goods_receive_no']); ?>&ttl_amt=<?= urlencode($data_header['total_amount']); ?>&vat_amt=<?= urlencode($data_header['vat_amount']); ?>','','#tampil2');"><i
							class="fa fa-edit"></i> <b>PROCESS TO INVOICE RECEIPT WITH FP</b></a>
					<?php
				} else {
					?>
					<!-- button 5 -------- -->
					...
					'INVOICE+RECEIPT',
					'400405',
					'INV4<?= $data_header["goods_receive_no"]; ?>',
