...
$tab_title = array("DISPUTE PRICE", "DISPUTE PRICE FINISH"); // ,"GOODS RECEIVE FINISHED"
$tab_ahref = array("tabcontent1", "tabcontent2");//,"tabcontent3"
$tab_status_active = isset($_REQUEST["param_menu4"]) ? ($_REQUEST["param_menu4"] - 1) : 0;
$style_tab = "background-color:#ccddee";

// tab content -----------------------
$tab_content_file = array("401001_01", "401001_02"); //,"400402_03"
