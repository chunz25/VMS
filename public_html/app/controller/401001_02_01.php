	...
	<hr>
          ...
          <div class="row no-print">
            <div class="col-xs-12">
				...
				<!-- button 1 -------- -->
					<a class="btn btn-default btn-flat btn-sm btn-info"  onclick="cobayy('DISPUTE+PRICE','401001','&param_menu4=2');"><i class="fa fa-edit"></i> <b>BACK TO LIST DISPUTE PRICE</b></a>
				 <!-- button 2 ---------- -->
