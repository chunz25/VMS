...
// die();
// sleep(5);
function cek_ukuran_file($param1 = "", $param2 = "", $param3 = "")
{
	$limitSize = 10 * 1024 * 1024;

	$resultnya = (($param1 < $limitSize) and ($param2 < $limitSize) and ($param3 < $limitSize)) ? "success" : "Ukuran File tidak boleh lebih dari 3 MB ";
...
function cek_jenis_file($param = "")
{
	...
	$resultnya = ($type_file == "pdf") ? "success" : "File Yang diUpload Harus dalam format pdf dan harus asli dari DJP ";
