...
<div class="modal fade" id="tampil04" role="dialog">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<h4 class="modal-title" id="exampleModalCenterTitle">CREATE USER LOGISTIK</h4>
						...
						<table class="tabelpopup">
							...
							<tbody>
								<tr>
									...
									<td class="tdpopup"><b>Logistik</b></td>
								</tr>
								<tr>
									<td class="tdpopup" align="right" width="40%">Group Akses</td>
									<td class="tdpopup"><b>Logistik Group User</b></td>
								</tr>
								<tr>
									<td class="tdpopup" align="right" width="40%">Nama lengkap</td>
									<td class="tdpopup"><input type="text" class="form-control" name="nama_lengkap"
											value="" style="background-color:lightblue;"></td>
								</tr>

								<tr>
									<td class="tdpopup" align="right" width="40%">Username</td>
									<td class="tdpopup"><input type="text" class="form-control" name="username" value=""
											style="background-color:lightblue;"></td>
								</tr>
								<tr>
									<td class="tdpopup" align="right" width="40%">Password</td>
									<td class="tdpopup"><input type="password" class="form-control" name="password"
											value="" style="background-color:lightblue;"></td>
								</tr>
								<tr>
									<td class="tdpopup" align="right" width="40%">Email</td>
									<td class="tdpopup"><input type="text" class="form-control" name="email" value=""
											style="background-color:lightblue;"></td>
								</tr>
								<tr>
									<td class="tdpopup" align="right" width="40%">No HP</td>
									<td class="tdpopup"><input type="text" class="form-control" name="no_hp" value=""
											style="background-color:lightblue;"></td>
								</tr>
								<tr>
									<td class="tdpopup" align="right" width="40%">Store CD/ Site CD</td>
									<td class="tdpopup"><input type="text" class="form-control" name="department"
											value="" style="background-color:lightblue;"></td>
								</tr>
