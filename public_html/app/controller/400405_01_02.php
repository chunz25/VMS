	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				<h4 class="modal-title" id="exampleModalCenterTitle">UPLOAD ULANG FAKTUR PAJAK #
					<?= $_REQUEST["po_no"]; ?>
				</h4>
			...
			<div class="modal-body" align="left">
				...
				<form role="form" id="my_form" action="index.php" method="post" enctype="multipart/form-data">
					<div class="box-body">
						...
						<input name="total_amountx" type="text"
							value="<?= number_format($data_header['total_amount']) ?>" size="45" readonly>
						<input name="vat_amountx" type="text" value="<?= number_format($data_header['vat_amount']) ?>"
							size="45" readonly>
						</br>
						</br>
						<div class="alert alert-info alert-dismissable">
							...
							- Selisih Pembulatan Total Amount < 1000 , Selisih Pembulatan Pajak < 100 </br>
						</div>
