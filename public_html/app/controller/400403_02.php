		...
		<TBODY>
			...
			?>
			  <tr valign="top">      
				...
				<td  align="center"><button class="btn btn-warning btn-xs btn-flat" data-toggle="modal" data-target="#add01" onclick="cobayy('SETTLEMENT+PRICE','400403_02_01','<?php echo $arr['proforma_invoice_no'];?>&param_menu4=<?php echo $arr['status_pfi'];?>');" ><?php echo $view_action;?> </button></td>			
			  </tr>
			<?php } ?>
		</TBODY>
		</TABLE>
