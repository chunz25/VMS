...
/*
	if (class_exists('cekTimeProcess')) {
		$cekTimeProcessNya=new cekTimeProcess("",$limitTimeProcess,__FILE__,$_SESSION["username"],__FILE__);
		// sleep(1);
	}
*/
...
// echo shell_exec("dir");
// echo shell_exec($_MAIN__CONFIGS_030[5].' -s '.$sql001);
	...
	<div class="row">
		<div class="col-xs-12">
			...
			<div class="box-tools pull-left">
				<!-- button 1 --------- -->
				<a class="btn btn-default btn-flat btn-sm btn-info" onclick="cobayy('HISTORY+PO','401302','<?php echo $_REQUEST["param_menu3"]; ?>&param_menu4=1');"><i class="fa fa-edit"></i><b>BACK TO HISTORY PO</b></a>
				<!-- button 2 --------- -->
				<?php
				if (($_SESSION['tb_id_user_type'] != "5") && ($_SESSION['tb_id_user_type'] != "6")) {
				?>
