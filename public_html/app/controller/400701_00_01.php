              ...
              <table class="table table-striped">		  
				...
				while ($arr = $rs->FetchRow()) { ?>
					  <tr valign="top">						
						...
						<td align=""><?php echo $arr['sir_no'];?></td>		
						<td align=""><?php echo $arr['remark'];?></td>		
						<td align="right"><?php echo number_format($arr['payment_amount'],0);?></td>							
					  </tr>
				<?php } ?>
				</TBODY>
				</TABLE>
            ...
            <div class="col-xs-6">             
              <div class="table-responsive">
                <table class="table">
                  ...
                  <tr>
                    <th>NET PAYMENT</th>
                    <td align="right"><b><?php echo number_format($data_header['net_payment'],0);?></b></td>
                  </tr>
                </table>
              </div>
            </div><!-- /.col -->
