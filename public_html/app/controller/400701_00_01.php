...
// data PAYMENT line -------------
$sql004 = "SELECT * FROM payment_item WHERE payment_no='" . $_REQUEST["param_menu3"] . "' and company_code='" . $_REQUEST["cc"] . "' AND SUBSTR(sir_no,5,1)!='1' order by CAST(line_item AS UNSIGNED)";
				...
				<TABLE class="table table-striped">
					<THEAD>
						<tr valign="top">
							...
							<th align="right"><b>GL ACCOUNT NO</b></th>
							<th align="right"><b>REMARK</b></th>
						...
						<?php if ($rs)
							while ($arr = $rs->FetchRow()) { ?>
								<tr valign="top">
									...
									<td align=""><?= $arr['sir_no']; ?></td>
									<td align=""><?= $arr['remark']; ?></td>
									<td align="right"><?= number_format($arr['payment_amount'], 0); ?></td>
								</tr>
							<?php } ?>
					</TBODY>
				</TABLE>
		...
		<div class="col-xs-6">
			<div class="table-responsive">
				<table class="table">
					...
					<tr>
						<th>NET PAYMENT</th>
						<td align="right"><b><?= number_format($data_header['net_payment'], 0); ?></b></td>
					</tr>
				</table>
			</div>
		</div><!-- /.col -->
		...
		<div class="col-xs-12">
			...
			<div class="box-tools pull-left">
				...
				<a class="btn btn-default btn-flat btn-sm btn-info"
					onclick="cobayy('PAYMENT+INFORMATION','400701','<?= $_REQUEST["param_menu3"]; ?>&param_menu4=1');"><i
						class="fa fa-edit"></i><b>BACK TO LIST PAYMENT</b></a>
			</div>
