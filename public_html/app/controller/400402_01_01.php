					...
					<?php if ($rs)
						while ($arr = $rs->FetchRow()) { ?>
							<tr valign="top">
								...
								<td align="right"><?= number_format(($arr['quantity'] / $arr['po_quantity']) * 100); ?>%
								</td>
							</tr>
						<?php } ?>
				</TBODY>
	...
	<div class="row">
		...
		<div class="col-xs-6">
			<p class="text-muted well well-sm no-shadow" style="margin-top: 10px;">
				<b> Note :</b> <br>
				- Jika Qty received tidak sesuai silahkan lakukan settlement dengan mengklik tombol "Dispute
				Quantity"<br>
			</p>
		</div><!-- /.col -->
		...
		<div class="col-xs-12">
			<div class="box-tools pull-left">
				...
				<a class="btn btn-default btn-flat btn-sm btn-info"
					onclick="cobayy('GOODS+RECEIVE','400402','&param_menu4=1');"><i class="fa fa-edit"></i> <b>BACK TO
						LIST GR</b></a>
				<!-- button 2 ---------- -->
			...
			<div class="box-tools pull-right">
				...
				<a class="btn btn-default btn-flat btn-sm btn-danger"
					onclick="dispute_process('Apakah Anda Yakin akan memproses dispute quantity.... ?','GOODS+RECEIVE','400402_01_03','<?= $data_header['goods_receive_no']; ?>')"><i
