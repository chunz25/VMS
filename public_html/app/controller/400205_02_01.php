...
?>
<div class="modal fade" id="tampil3" role="dialog">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				<h2 class="modal-title" id="exampleModalCenterTitle">REVISI INV RECEIPT #
					<?= $_REQUEST["po_no"]; ?>
				</h2>
				...
				<form role="form" id="my_form" action="index.php" method="post" enctype="multipart/form-data">
					<div class="box-body">
						...
						<input name="address" type="text"
							value="<?= number_format($data_header['total_amount']) ?>" size="45" disabled>
						<input name="address" type="text"
							value="<?= number_format($data_header['vat_amount']) ?>" size="45" disabled>
						</br>
						<label>Link :</label></br>
