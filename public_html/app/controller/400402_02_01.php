					...
					<?php if ($rs)
						while ($arr = $rs->FetchRow()) {
							...
							<tr valign="top">
								...
								<td align="right"><?= number_format($arr['qty_ori']); ?></td>
								<?php if ($data_header['revision_seq'] > 0) { ?>
		...
		<div class="col-xs-12">
			<div class="box-tools pull-left">
				...
				<a class="btn btn-default btn-flat btn-sm btn-info"
					onclick="cobayy('GOODS+RECEIVE','400402','&param_menu4=2');"><i class="fa fa-edit"></i> <b>BACK TO
						LIST GR</b></a>
				<!-- button 2 ---------- -->
			...
			<div class="box-tools pull-right">
				<?php if ($_REQUEST["param_menu4"] == '23') { ?>
					...
					<a class="btn btn-default btn-flat btn-sm btn-danger"
						onclick="dispute_process('Apakah Anda Yakin akan memproses dispute quantity.... ?','GOODS+RECEIVE','400402_02_03','<?= $data_header['goods_receive_no']; ?>')"><i
