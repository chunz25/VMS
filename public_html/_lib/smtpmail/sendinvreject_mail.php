...
try {
    ...
    $mail->isHTML(true);
    $mail->Subject = 'VMS: Reject Invoice ' . $inv;
    $mail->Body    = '
                    <p>Dear bapak/ibu </p>
                    <p>FYI , Berikut list reject atas Receipt Supplier pada Proses Invoice yang di ajukan oleh vendor di Vendor Management System ECI :</p>
