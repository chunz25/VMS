...
class ADODB_Pager {
	...
	global $PHP_SELF;
		if ($anchor) {
	?>
		<a href="<?= $PHP_SELF,'?',$this->id;?>_next_page=1"><?= $this->first;?></a> &nbsp;
	<?php
		} else {
			print "$this->first &nbsp; ";
		}
	...
	global $PHP_SELF;
		...
		if ($anchor) {
		?>
		<a href="<?= $PHP_SELF,'?',$this->id,'_next_page=',$this->rs->AbsolutePage() + 1 ?>"><?= $this->next;?></a> &nbsp;
		<?php
		} else {
			print "$this->next &nbsp; ";
		}
	...
	global $PHP_SELF;
		...
		if ($anchor) {
		?>
			<a href="<?= $PHP_SELF,'?',$this->id,'_next_page=',$this->rs->LastPageNo() ?>"><?= $this->last;?></a> &nbsp;
		<?php
		} else {
			print "$this->last &nbsp; ";
		}
	...
	global $PHP_SELF;
		if ($anchor) {
	?>
		<a href="<?= $PHP_SELF,'?',$this->id,'_next_page=',$this->rs->AbsolutePage() - 1 ?>"><?= $this->prev;?></a> &nbsp;
	<?php
		} else {
			print "$this->prev &nbsp; ";
		}
