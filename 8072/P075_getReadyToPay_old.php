...
$sqlInsert = "INSERT INTO vms_db.sap_ready_to_pay (typ, goods_receive_no, accounting_no, invoice_no, purchase_order_no, reference_no, company_code, store_code,supplier_code, document_date, posting_date, due_date, payment_date, status, amount, insert_date) VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?,?,?,current_timestamp());
";
// eksekusi insert ---
